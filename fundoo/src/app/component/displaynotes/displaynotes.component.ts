...
export class DisplaynotesComponent implements OnInit {
  ...
  notes = [
    ...
    { color: "slategray", name: "grey", title: "karim", description: "from karlapalem", isarchived: "1", istrash: false, },
    ...
    { color: "rgb(174,203,250)", name: "Dark blue", title: "shabbir", description: "from karlapalem", isarchived: true, istrash: "0" }
  ]
